...
# python fruits_openim_plot.py --name vanilla_from_scratch_7 --thres 0.5701 --energy 1 --seed 0
import pickle
import torch
...
# id_data = pickle.load(open(root +args.name+'/random_seed'+'_'+str(args.seed)+'/inference/openim_id_fruits_val/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
# ood_data = pickle.load(open(root+args.name+'/random_seed'+'_'+str(args.seed)+'/inference/openim_ood_sim_fruits_test/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))

id_data = pickle.load(open(root +args.name+'/random_seed'+'_'+str(args.seed)+'/inference/openim_id_fruits_val/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
ood_data = pickle.load(open(root+args.name+'/random_seed'+'_'+str(args.seed)+'/inference/openim_ood_diff_fruits_test/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
