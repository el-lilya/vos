...
id_data = pickle.load(open(root +args.name+'/random_seed'+'_'+str(args.seed)+'/inference/coco_ext_fruits_val/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
ood_data = pickle.load(open(root+args.name+'/random_seed'+'_'+str(args.seed)+'/inference/coco_neg_ood_fruits_test/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
